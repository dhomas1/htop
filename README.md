...
Check the [releases](https://github.com/dhomas1/htop/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/dhomas1/htop.git
cd htop
./build.sh
ls -la *.tgz
```
